...
namespace ink {
	...
	template<typename X, typename Y, typename Z>
	Vec(X,Y,Z) -> Vec<
		std::conditional_t<(std::is_null_pointer_v<X> || std::same_as<X, generic_vec::Empty>), void, X>,
		std::conditional_t<(std::is_null_pointer_v<Y> || std::same_as<Y, generic_vec::Empty>), void, Y>,
		std::conditional_t<(std::is_null_pointer_v<Z> || std::same_as<Z, generic_vec::Empty>), void, Z>>;
	
	template<typename X, typename Y>
	Vec(X,Y) -> Vec<
		std::conditional_t<(std::is_null_pointer_v<X> || std::same_as<X, generic_vec::Empty>), void, X>,
		std::conditional_t<(std::is_null_pointer_v<Y> || std::same_as<Y, generic_vec::Empty>), void, Y>, void>;
